...
> = ({ onClose }) => {
  ...
  const loadCategories = async (): Promise<CatalogItem[]> => {
    const data =
      await problemApi.getProblemCategoriesForSettings();
  ...
  const loadProblemTypes = async (): Promise<CatalogItem[]> => {
    const data =
      await problemApi.getProblemTypesForSettings();
  ...
  const loadDefectTypes = async (): Promise<CatalogItem[]> => {
    const data =
      await problemApi.getDefectTypesForSettings();
    ...
    >
      <div style={styles.modal}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>
              Configure catalogs used by Problem Control.
            </p>
          </div>
        ...
        <div style={styles.tabs}>
          ...
          <button
            type="button"
            onClick={() => setActiveTab('defect-types')}
            style={{
              ...styles.tab,
        ...
        <div style={styles.content}>
          {activeTab === 'categories' && (
            <CatalogSettings
              ...
              createItem={async (data) => {
                await problemApi.createProblemCategory({
                  value: data.key,
                  label: data.label,
              ...
              updateItem={async (id, data) => {
                await problemApi.updateProblemCategory(
                  id,
                  data
                );
          ...
          {activeTab === 'problem-types' && (
            <CatalogSettings
              ...
              createItem={async (data) => {
                await problemApi.createProblemType({
                  value: data.key,
                  label: data.label,
                  is_active: data.is_active,
                });
              ...
              updateItem={async (id, data) => {
                await problemApi.updateProblemType(
                  id,
                  data
                );
          ...
          {activeTab === 'defect-types' && (
            <CatalogSettings
              ...
              createItem={async (data) => {
                await problemApi.createDefectType({
                  code: data.key,
              ...
              updateItem={async (id, data) => {
                await problemApi.updateDefectType(
                  id,
                  {
                    description: data.label,
                    is_active: data.is_active,
