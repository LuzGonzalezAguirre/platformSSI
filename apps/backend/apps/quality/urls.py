...
urlpatterns = [
    ...
    # Problem Control configurable catalogs
    path("problem-categories/", ProblemCategoryListCreateView.as_view(), name="problem-category-list-create"),
    path("problem-categories/<int:pk>/", ProblemCategoryDetailView.as_view(), name="problem-category-detail"),
    path("problem-types/", ProblemTypeListCreateView.as_view(), name="problem-type-list-create"),
    path("problem-types/<int:pk>/", ProblemTypeDetailView.as_view(), name="problem-type-detail"),
    path("defect-types/<int:pk>/", DefectTypeDetailView.as_view(), name="defect-type-detail"),
]
